...
public class WatchListRsp {
	
	private List<WatchListPojo> lp;
	
	private Integer retcode ;
	
	private String msg;

	public List<WatchListPojo> getLp() {
		return lp;
	}

	public void setLp(List<WatchListPojo> lp) {
		this.lp = lp;
	}
...
class WatchListPojo extends PartWatchPojo{
